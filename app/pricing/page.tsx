...
export default function PricingPage() {
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-[#EDEDED]">
      ...
      <section className="mx-auto grid w-full max-w-7xl gap-8 px-4 py-10 lg:grid-cols-2 sm:px-6 lg:px-8">
        <motion.div
        ...
        >
          ...
          <form className="mt-6 space-y-4" onSubmit={onSubmit}>
            ...
            <button
              type="submit"
              className="inline-flex w-full items-center justify-center rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 px-4 py-2.5 text-sm font-medium text-white transition-all hover:brightness-110"
            >
              Secure My Spot
            </button>
          </form>
